...
<body class="${data.pageClass}">
  <header>
      ...
      <h2 class="instructions">${data.bannerTitle}
  ...
  <footer class="footer-main container">
    <div class="content">
      ...
      <p>Learn about how <a href="https://netlify.com/open-source?utm_term=oss-love">we support OSS</a> and getting your project onto our <a href="https://netlify.com/legal/open-source-policy?utm_term=oss-love">free Open Source plan</a>.</p>
      <p><a class="button blue" href="https://app.netlify.com/signup?utm_term=oss-love">Get started for free</a></p>
      <a href="//netlify.com?utm_term=oss-love" class="netlify-logo">
